...
<div class="row">
	<div class="col-md-12">
		<h3>View Article</h3>
		<p>
			<a href="{{ route('admin.article.management') }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back to Articles</a>
		</p>
		...
		<div class="content-box-large box-with-header">
			...
			<form action="{{ route('admin.approve.article.post') }}" method="POST" autocomplete="off">
				{{ csrf_field() }}
				...
				<div class="form-group">
					...
					<a href="{{ route('admin.article.management') }}" class="btn btn-danger">Cancel</a>
				</div>
			</form>
...
@include('admin.includes.modal-article-deny')
@endsection