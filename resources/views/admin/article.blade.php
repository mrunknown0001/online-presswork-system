...
<div class="row">
	<div class="col-md-12">
		...
		<p>
			<a href="{{ route('admin.view.approved.article') }}" class="btn btn-success btn-sm"><i class="fa fa-eye"></i> View Approved Articles</a>
			<a href="{{ route('admin.view.denied.article') }}" class="btn btn-warning btn-sm"><i class="fa fa-eye"></i> View Denied Articles</a>
		</p>
				...
				<tbody>
					@foreach($articles as $a)
						<tr>
							...
							<td class="text-center">
								<a href="{{ route('admin.view.edit.article', ['id' => $a->id]) }}" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> View</a>
							</td>
						</tr>
					@endforeach
				</tbody>
