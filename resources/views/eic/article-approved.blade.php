				...
				<tbody>
					@foreach($articles as $a)
						<tr>
							...
							<td class="text-center">
								<a href="{{ route('eic.download.article', ['id' => $a]) }}" class="btn btn-primary btn-xs"><i class="fa fa-download"></i> Download</a> <a href="{{ route('eic.article.versions', ['id' => $a->id]) }}" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> View Versions</a>
							</td>
						</tr>
					@endforeach
				</tbody>
